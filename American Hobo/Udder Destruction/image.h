...
class Image
{
  ...
  public:
	...
	virtual void setCenterX(float newX) {spriteData.x = newX - spriteData.width/2;} ///[added]

	virtual void setCenterY(float newY) {spriteData.y = newY - spriteData.height/2;}///[added]
